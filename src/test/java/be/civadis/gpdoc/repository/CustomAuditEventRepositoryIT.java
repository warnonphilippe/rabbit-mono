package be.civadis.gpdoc.repository;

import be.civadis.gpdoc.GpdocApp;
import be.civadis.gpdoc.config.Constants;
import be.civadis.gpdoc.config.TestSecurityConfiguration;
import be.civadis.gpdoc.config.audit.AuditEventConverter;
import be.civadis.gpdoc.domain.PersistentAuditEvent;
...
import static be.civadis.gpdoc.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
